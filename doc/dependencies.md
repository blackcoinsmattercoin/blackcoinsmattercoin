...
These are the dependencies currently used by Blackcoinsmattercoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| Qt | [5.9.9](https://download.qt.io/archive/qt/) | [5.2](https://github.com/bitcoin/bitcoin/pull/14725) | No |  |  |
...
Telegram - https://t.me/blackcoinsmattercoin
Keybase  - https://keybase.io/team/blackcoinsmattercoin/
