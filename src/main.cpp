...
#if defined(NDEBUG)
# error "Blackcoinsmattercoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Blackcoinsmattercoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Blackcoinsmattercoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Blackcoinsmattercoin also requires low S in sigs
