...
const QString BITCOIN_IPC_PREFIX("blackcoinsmattercoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/blackcoinsmattercoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/blackcoinsmattercoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/blackcoinsmattercoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click blackcoinsmattercoin: links
...
//
// OSX-specific way of handling blackcoinsmattercoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in blackcoinsmattercoin: URIs
...
void PaymentServer::handleURIOrFile(const QString &s)
{
    ...
    // blackcoinsmattercoin: CashAddr URI
    ...
    // blackcoinsmattercoin: Legacy URI
