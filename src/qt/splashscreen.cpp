    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBlackcoinsmattercoin   = QChar(0xA9)+QString(" %1 ").arg(2021) + QString("The Blackcoinsmattercoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextBlackcoinsmattercoin);
    }
