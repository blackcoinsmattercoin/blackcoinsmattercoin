...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"blackcoinsmattercoinaddress\"\n"
            "\nReveals the private key corresponding to 'blackcoinsmattercoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"blackcoinsmattercoinaddress\"   (string, required) The blackcoinsmattercoin address for the private key\n"
            "\nResult:\n"
